    ...
    <>
      ...
      <Container>
        <Card className="p-4 shadow" style={{ marginTop: "20px", background: "white" }}>
          ...
          {currentIndex ? (
            <ToolkitProvider bootstrap4 keyField="date" data={currentIndex} columns={columns2} defaultSorted2={defaultSort2} search exportCSV={{ onlyExportFiltered: true, exportAll: false }}>
              {(props) => (
                <div>
          ...
          {currentIndex2 ? (
            <ToolkitProvider bootstrap4 keyField="date" data={currentIndex2} columns={columns} defaultSorted={defaultSort} search exportCSV>
              {(props) => (
                <div>
                  <Container fluid className="d-flex p-3 align-content-between justify-content-between">
                    <SearchBar {...props.searchProps} />
